package com.example.restaurantrecognition.ui.zomato;
...
public class ZomatoRequest {
    ...
    public String findMatchingRestaurants(String restaurant, double lat, double lon) {
        ...
        try {
            ...
            // Add Request Body to URL;
            urlString+="q="; urlString+=restaurant;
            urlString+="&lat="; urlString+=lat;
            urlString+="&lon="; urlString+=lon;
            urlString+="&count="; urlString+=countParameter;
    ...
    public String getReview(int res_id, int offset) {
        final String method_path = "review?";
